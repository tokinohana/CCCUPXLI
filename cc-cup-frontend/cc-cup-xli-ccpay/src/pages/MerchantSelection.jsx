...
const MerchantSelection = () => {
  ...
  // Simplified array flat list without metadata parameters
  const merchants = [
    { id: 1, name: "Kantin Pusat 01", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuB8DLxro5zEVcQq2TPH6DkgDpjw6nspt81XB08FoWJ1mAO2ibMWOjAVrxXhuBkI9zCAG4biL8Tkwaj5hMltjbggTSOnhHcNmx8IMNGnsTQz_t1TVJKo2TfPsneqmJqiNE8NMVNyRjW3nyDEBp_dj9QPfTATVc2lYUU2qUxiAq3oJB0SG_BZi0H7Vh1qzNP7fDIrCyA55iNbbpih2k8a5GJ48FOXThy3sBvqTrVpAVPwEk8fkzW3DiyxfAR81JWwG3lzrhn3pq_Mw2k" },
    { id: 2, name: "Steak & Grill", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAFfjZ1q-cUp_mzu4oC987oaUpPOh0HET_3LDqioWQJDvA5SmiMlpDCOjjkVCMGhxoSfVBxgDz_1lDOC-jhyJ7qeVnVNmlAYxi35tbgTRqr9tP9Toeh_-BX0gkJbR5065f0u9jXVXCNftr9LtoeZGJ5kcSRgesox_FV1DswWLoyn4XE7Ag8KOTiOlC-nGmwIbVmOgm0AbrlKzt6VRheN2Cmv0HQ3BT8Eh-JZPiFo9Dnv5MPkLzia2yYQblOJXycQn26JHnCwumlSZs" },
    { id: 3, name: "Kantin 03 (Warteg)", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCa-xEY9MRLI6KHIpFEcNcd_NfxMrREEC67Z7zn_tQ1TC8-6nz5IlRO1020oPQ9RDw-ADcdbKBGZ9ME_znzLmL8j2yDGl2kFRy9KS3AG-DtUJ8nWMhgpkdOKYMYOxA1BAFeqxd9NiCe0rEvNE-6q5G4WxbbP0RarzWAVLu37fCY328vcSeGvNBk5iA_VI8dO6zmPiIh-OOpu_43C2iTfQKAWpUprN8QfJGdzXktZ-2IaGsQ15zAXglXNkmeChzr11WNlrpf9wxcf_M" },
    { id: 4, name: "Gorengan Pak No", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCXKBjI2LICmkLVqWuGe5P_NR0OJmhbmh-PJylboIXxb83dRGQjzV18Ba1wKJKj4Saes2z4_s8wsQDEFb72H6siW_OwePPn0mzF70O4PLNPGm9YkyKFAQ8t49kpAhUE-auMPqBJCLv-evOVGGNDcrB27Qb4djGP_4QiozWpzVCAieD66nGhPGELznzHf88vNCTMJArHGfb0LLPeQdvWwsQLY9vpnoR4ZA-qlYCcozoPkaFY5Cueixc-ZZLxx2ExGD5T4U7_xm3Jx1U" },
    { id: 5, name: "Es Campur Segar", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD7FrHfI2y6GFYP0F9j_RY5Yj_x-dhjv512j1mNdub9_T9LmSHQIFzvA4zWAo07ELJjWrX6WrWKNVzOUgFfcuNeYPbgUoMFDBnPcUYDDQRLJPNf5ptL2gKhdhtmZ1Csbr7zr8h7OBEVn4btDQO9bZrg1UXtitxxL4WVcz0dZsdsveISdKshRg-6qknkV0WkGiNN9OkvalocSUvRU67jcKdg6cItC34MaGY4UnwCNNK2Jihy40KFy70dQj3KBFCo5wS9i8REsGgzEp8" }
  ];
        ...
        <div className="space-y-2.5">
          {isLoading ? (
            ...
            filteredMerchants.map((merchant) => (
              <div 
                key={merchant.id}
                onClick={() => navigate('/input', { state: { merchant } })}
